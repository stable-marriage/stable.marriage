...
ALGLIST1=("PolyMin" "DACC_D" "PowerBalance_SEq" "BiLS_Old_SEq_0.0" "BiLS_SEq_0.125" "Hybrid_SEq" "HybridMultiSearch_SEq")
ALGLIST2=("PolyMin" "DACC_D" "PowerBalance_Bal" "BiLS_Old_Bal_0.0" "BiLS_Bal_0.125" "Hybrid_Bal" "HybridMultiSearch_Bal")
