...
declare -a ALG_LIST=("GS_MaleOpt" "GS_FemaleOpt" "MinEgalitarian" "MinRegret" "DACC -s D" "PowerBalance -c SEq" "PowerBalance -c Bal" "BiLS -c SEq -p 0.125" "BiLS -c Bal -p 0.125" "BiLS_Old -c SEq -p 0" "BiLS_Old -c Bal -p 0" "Hybrid -c SEq" "Hybrid -c Bal" "HybridMultiSearch -c SEq" "HybridMultiSearch -c Bal")
