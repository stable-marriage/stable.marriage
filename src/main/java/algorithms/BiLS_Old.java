...
public class BiLS_Old extends Abstract_SM_Algorithm
{
    double probability;
    String cost_to_optimize;

    public BiLS_Old(int n, String menFileName, String womenFileName, Double prob, String optCost)
    {
    ...
    public BiLS_Old(int n, Agent[][] agents, Double prob, String optCost)
    {
        super(n, agents);
        this.probability = prob;
        this.cost_to_optimize = optCost;
    ...
    {
        int[][] starting_mIndex_left, starting_mIndex_right;
    ...
    public static void main(String args[]) 
    {
        ...
        Abstract_SM_Algorithm smp = new BiLS_Old(n, menFile, womenFile, probability, opt_cost);
